  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-white">Sruthi Karanam</h3>
        <p className="text-lg font-normal text-gray-400">
          B.Tech CSE (AI&DS) Student
        </p>
        <p className="text-base text-gray-400 tracking-wide">
          Passionate about data science, AI, machine learning, and software development. Experienced in web development, database management, and AI-based projects.
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Phone: <span className="text-lightText">+91 7989219149</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email: <span className="text-lightText">karanamsruthi17@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
